...
RAW_DATA_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), 'data', 'raw_data.csv'))
EXPANDED_DATA_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), 'data', 'expanded_data.csv'))
